    ...
    <div className="mx-6">
      ...
      <section>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="my-8 text-center">
            <button type="submit" className="btn btn-lg text-white bg-gradient-to-r from-[#835D23] to-[#B58130]  py-4 px-8">
      ...
      <section>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 justify-items-center items-center bg-[#F3F3F3] py-6">
            <div>
